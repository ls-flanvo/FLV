    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-invert max-w-none space-y-8 text-ink-secondary leading-relaxed">
        {[
          ...
          { title: '3. Prenotazioni e pagamenti', body: 'Il prezzo viene calcolato in base alla distanza proporzionale e al numero di passeggeri. Al momento della prenotazione viene effettuata una pre-autorizzazione della carta (fondi bloccati, non addebitati). L\'addebito effettivo avviene al momento dell\'accettazione della corsa da parte del driver. La pre-autorizzazione decade automaticamente se il gruppo non si forma o se il driver non è disponibile.' },
