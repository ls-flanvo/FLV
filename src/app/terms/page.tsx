    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-invert max-w-none space-y-8 text-ink-secondary leading-relaxed">
        {[
          ...
          { title: '4. Cancellazioni e rimborsi', body: 'Puoi cancellare la prenotazione gratuitamente in qualsiasi momento fino a quando il driver non ha accettato la corsa. In quel momento la pre-autorizzazione sulla carta viene rilasciata integralmente e nessun importo viene addebitato. Dopo che il driver accetta, la cancellazione non è consentita poiché il driver si è già impegnato. In caso di volo cancellato o dirottato certificato dal vettore aereo, il rimborso è sempre integrale indipendentemente dallo stato della corsa.' },
