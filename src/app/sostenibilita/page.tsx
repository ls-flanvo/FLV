  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="flex items-center gap-3 mb-2">
        ...
        <h1 className="text-3xl font-bold text-white">Sostenibilità</h1>
      </div>
      <p className="text-ink-muted text-sm mb-12">Il nostro impatto ambientale e i nostri obiettivi.</p>
