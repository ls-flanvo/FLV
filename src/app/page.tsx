          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
            ...
            <div className="md:col-span-6 bg-gradient-to-r from-surface-2 via-surface-3 to-surface-2 border border-surface-5 rounded-3xl p-8 flex flex-col md:flex-row items-center gap-6 group hover:border-primary-500/20 transition-all">
              ...
              <div className="text-center md:text-left">
                <h3 className="text-xl font-bold text-white mb-2">Van NCC, non un taxi stretto dopo ore di volo</h3>
                <div className="flex flex-wrap gap-x-5 gap-y-1">
                  {[
                    'Spazio reale per bagagli e trolley',
                    'Sedili comodi, nessuna coincidenza',
                    'Porta a porta — scendi a casa tua',
                    'Driver sincronizzato col tuo volo',
                  ].map(t => (
                    <span key={t} className="flex items-center gap-1.5 text-sm text-ink-secondary">
                      <CheckCircle className="w-3.5 h-3.5 text-primary-400 shrink-0" />{t}
                    </span>
                  ))}
                </div>
              </div>
